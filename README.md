...
- **`cleaned_data`**: The final dataset after Power Query processing.
  - [sales_cleaned_data.csv](https://github.com/VoThNhuY/Data-Cleaning-PowerQuery-/blob/main/sales_cleaned_data.csv)
  - [country_cleaned_data.csv](https://github.com/VoThNhuY/Data-Cleaning-PowerQuery-/blob/main/country_cleaned_data.csv)
  - [cleaned_data.xlsx](https://github.com/VoThNhuY/Data-Cleaning-PowerQuery-/blob/main/cleaned_data.xlsx): Excel version containing the Power Query transformation steps.
...
- **Result**: Converted the dataset from a **horizontal** (Wide format) to a **vertical** (Long format), creating two new columns: Month and Quantity.
...
- **Relationship**: Linked the two tables via the **CountryCode** column, establishing a **One-to-Many (1:*) relationship** between the Country (Dimension) and Sales (Fact) tables.
...
- **Automated:**: Click "Refresh" to process new data instantly.
